...
export default function ModalImage({ handler, image }) {
  return (
    <>
      <div className="w-full h-full flex fixed left-0 top-0 justify-center z-40 items-center">
        <div
          onClick={handler}
          className="w-full h-full fixed left-0 right-0 bg-black  bg-opacity-65"
        ></div>
        <div
          className="md:w-[612px] w-[310px] md:h-[500px] relative z-50 bg-slate-700 md:pl-10 pl-3 py-[108px] flex flex-col justify-between rounded-md"
          style={{
