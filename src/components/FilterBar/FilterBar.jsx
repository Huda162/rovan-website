...
export default function FilterBar({
  ...
  return (
    <div
      className="xl:w-[20%] lg:w-[20%] sm:w-full p-4 rounded-lg shadow-md hidden xl:block lg:block md:hidden"
      style={{ backgroundColor: "white", marginLeft: "2rem" }}
    >
      {withCategories && (
        <div class="pb-10 border-b border-qgray-border mt-3">
        <p style={{ paddingBottom: "1rem", fontWeight: "bold" }}> {t("filter")}</p>
      ...
      <p style={{ paddingBottom: "1rem", fontWeight: "bold" }}> {t("sort")}</p>
