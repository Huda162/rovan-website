  ...
  return (
    ...
    >
      ...
      <div className="product-card-details flex justify-center h-[102px] items-center  relative">
        {/* add to card button */}
        <div className="absolute w-[204px] h-[54px] left-[35px] -bottom-20 group-hover:bottom-[95px] transition-all duration-300 ease-in-out">
      ...
      {/* quick-access-btns */}
      <div className="quick-access-btns flex flex-col space-y-2 absolute group-hover:right-[30px] -right-[50px] top-20  transition-all duration-300 ease-in-out">
        <a href="#">
